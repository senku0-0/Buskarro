"""
Django settings for Buskarro project.
...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # Allows Gunicorn to serve static files
]


ROOT_URLCONF = 'Buskarro.urls'
...
WSGI_APPLICATION = 'Buskarro.wsgi.application'
...
# Adding of files starts over here
STATICFILES_DIRS=[
