document.addEventListener('DOMContentLoaded', () => {
    const fromSearchBar = document.getElementById('search-bar-from1');
    const fromResultsList = document.getElementById('results-from1');
    const toSearchBar = document.getElementById('search-bar-to1');
    const toResultsList = document.getElementById('results-to1');
    const data = [
        "Swargate,Pune",
        "Majestic,Bengaluru",
        "Koyambedu,Chennai",
